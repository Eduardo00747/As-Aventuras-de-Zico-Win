...
public class LifeController : MonoBehaviour
{
    ...
    {
        if (collision.gameObject.CompareTag("Inimigo") || collision.gameObject.CompareTag("Queda") || collision.gameObject.CompareTag("Abutre") || collision.gameObject.CompareTag("CascoPreto") || collision.gameObject.CompareTag("Javali"))
        {
